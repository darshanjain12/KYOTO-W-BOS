...
class Device:
  ...
  def __init__(self, device_name, device_type, cloud_device_id): #cloud_device_id
    self._name = device_name
    self._type = device_type
    #self._id = device_id
    self._cloud_device_id = cloud_device_id #cloud_device_id
    self._connections = {}
    self._translation = {}
    self._links = {}
  ...
  def to_dictionary(self):
    return_dictionary = {
      self._name: {
        "type": self._type,
        "cloud_device_id": self._cloud_device_id #cloud_device_id
      }
    }
